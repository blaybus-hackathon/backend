...
public interface HelperService {
    ...
    List<MatchingListResponseDTO> getHelperMatchingList(UserDetails userDetails);

    MatchedPatientResponseDTO getMatchedPatient(Long patientId, UserDetails userDetails);

    List<MatchedListResponseDTO> getMatchedPatientList(UserDetails userDetails);

    TblPatient getMathedPatientDetail(Long patientId);
}
